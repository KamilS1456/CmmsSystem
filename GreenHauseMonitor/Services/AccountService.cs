...
namespace Cmms.Services
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService(CmmsDbContext dbContext, IMapper mapper, IPasswordHasher<IdentityUser> passwordHasher, AuthenticationSettings authenticationSettings, IUserContextService userContextService, IAuthorizationService authorizationService)
        {
